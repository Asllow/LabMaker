...
@section('main')
    <div class="navbar">
        <div class="nav-item">
            <div class="itens">
                <div class="flex flex-col items-center w-full mt-3 upper-items">
                    <a class="flex items-center w-full h-12 px-3 mt-2 rounded bg-gray-300" href="{{ route('dashboard') }}">
                ...
                <div class="flex flex-col items-center w-full mt-2 border-t border-gray-300 low-items">
                    ...
                    @endif
                    <a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300" href="{{route('dashboard.perfil')}}">
                        <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
