        ...
        <header class="px-4 py-2 shadow">
            <div class="flex justify-between">
                ...
                <div class="flex items-center">
                    ...
                    <button data-dropdown class="flex items-center px-3 py-2 focus:outline-none hover:bg-gray-200 hover:rounded-md" type="button" x-data="{ open: false }" @click="open = true" :class="{ 'perfil-select': open }">
