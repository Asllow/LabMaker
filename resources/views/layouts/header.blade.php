                ...
                <div class='menu'>
                    <ul class='grid'>
                        ...
                        @auth()
                            ...
                            <div class="flex items-center px-3 py-2 focus:outline-none hover:bg-gray-200 hover:rounded-md" data-dropdown class='perfil' type="button" x-data="{ open: false }" @click="open = true" :class="{ 'bg-gray-200 rounded-md': open }">
