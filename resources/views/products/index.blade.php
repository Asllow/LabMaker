...
@section('contents')
    <div>
        ...
        <a href="{{route('makesoft.produtos.criar')}}" class="text-white float-right bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Adicionar Produtos</a>
        @if (session('success'))
            ...
            @if($product->count() > 0)
                @foreach($product as $rs)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td>
                            <img src="{{ $rs->img_produto }}" width="50" height="50">
                        </td>
                        <td>
                            {{ $rs->nome_produto }}
                        </td>
